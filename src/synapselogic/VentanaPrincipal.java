...
/**
 * Ventana principal del programa (SynapseLogic). 
 * Gestiona la interfaz gráfica de usuario (GUI) 
 para poder así realizar el análisis de conectividad.
 * Implementa todas las clases principales y usa el JFileChooser para cargar
  los archivos CSV. 
 * @author jd060
 */
...
public class VentanaPrincipal extends JFrame {
    ...
    /**
     * Realiza la carga y el procesamiento del archivo CSV. 
     * Utiliza el componte JFileChooser para la selección de los archivos. 
     */
    private void cargarCSV() {
        if (diccionario == null || diccionario.getTamaño() == 0) {
            JOptionPane.showMessageDialog(this, "Por favor, cargar el diccionario de Neurotransmisores",
                "Secuencia requerida",
                JOptionPane.WARNING_MESSAGE);
            return;
        }
        JFileChooser selector = new JFileChooser();
        selector.setDialogTitle("Seleccione el archivo CSV");
        int respuesta = selector.showOpenDialog(this);
        if (respuesta != JFileChooser.APPROVE_OPTION) {
            JOptionPane.showMessageDialog(this, "Operación cancelada. No se seleccionó ningún archivo CSV", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error en el contenido del archivo", "Vuelva a intentar", JOptionPane.ERROR_MESSAGE);
        } catch (Exception ex) {
    ...
    /**
     * Realiza la carga del diccionario de los neurotransmisores. 
     * Inicializa la estructura de HashTable para insertar los datos correspondientes.
     */
    ...
    private void cargarDiccionario() {
        ...
        int respuesta = selector.showOpenDialog(this);
        if (respuesta != JFileChooser.APPROVE_OPTION) {
            JOptionPane.showMessageDialog(this, "Operación cancelada. No se seleccionó ningún diccionario", "Aviso", JOptionPane.ERROR_MESSAGE);
            return;
        }
        File archivo = selector.getSelectedFile();
        try {
    ...
    /**
     * Se busca dentro de la red neuronal las zonas que hayan pérdido conexión.
     * Inicia desde una neurona raíz y luego determina si existe el elemento y el tipo. 
     */
    ...
    /**
     * Calcula e identifica la ruta más conveniente para la transmisión entre dos neuronas. 
     * Para esto, se solicita al usuario los identificadores de origen y destino. 
     */
    ...
    /**
     * Añade de forma interactiva una nueva neurona al grafo. 
     * Se solicita un identificador único al usuario para poder generarla. 
     */
    ...
    /**
     * Registra manualmente una nueva sinapsis dirigina entre dos neuronas ya existentes. 
     * Consigue los valores necesarios para su creación: origen, destino, distancia, identificador.
     */
    ...
    /**
     * Simula como afectaría la fatiga dentro de la red neuronal. 
     * Modifica globalmente los coeficientes de resistencia incrementandolos por 1.2.
     */
    ...
    /**
     * Consulta el diccionaro interno y muestra la información relacionada con
     * un neurotransmisor específico dentro de la Hash Table. 
     */
